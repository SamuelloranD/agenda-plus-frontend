...
export function ClientAppointmentsPage() {
  ...
  const appointments = useAgendamentos({ clienteId: user?.id, escopo: 'cliente', pagina: 0, tamanho: 20 })
