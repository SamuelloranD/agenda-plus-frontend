...
export function DashboardPage() {
  ...
  return <section className="dashboard-page">
    <style>{dashboardStyles}</style><style>{appointmentActionStyles}</style>
