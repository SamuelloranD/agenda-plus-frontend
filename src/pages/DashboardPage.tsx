...
.dashboard-page{background-image:radial-gradient(#d9cfc0 .6px,transparent .6px);background-size:18px 18px;padding:2px 0 48px}.dashboard-lead{max-width:820px;margin-bottom:32px}.section-label{margin:0 0 9px;color:var(--terracotta);font-size:10px;font-weight:700;letter-spacing:.16em;text-transform:uppercase}.dashboard-lead h2{margin:0;font:400 clamp(34px,4vw,54px)/1.04 'Newsreader',Georgia,serif;letter-spacing:-.025em}.dashboard-lead h2 em{color:var(--terracotta);font-weight:400}.metric-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));border:1px solid var(--line);background:#f4efe6}.metric-card{min-height:180px;padding:24px;border-right:1px solid var(--line);background:rgb(251 249 245 / 72%)}.metric-card:last-child{border-right:0}.metric-card p{margin:0;font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.metric-card strong{display:block;margin:20px 0 13px;font:500 50px/1 'Newsreader',Georgia,serif}.metric-card span{color:var(--muted-ink);font-size:12px}.metric-card--terracotta strong{color:var(--terracotta)}.metric-card--olive strong{color:var(--olive)}.metric-card--mustard strong{color:#97630d}.metric-card--muted strong{color:var(--muted-ink)}.today-panel{margin-top:32px;padding:28px;background:rgb(244 239 230 / 72%);border:1px solid var(--line)}.section-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:20px}.section-heading h3{margin:0;font:500 29px/1.15 'Newsreader',Georgia,serif}.section-heading>span{color:var(--muted-ink);font-size:11px;letter-spacing:.08em;text-transform:uppercase}.today-list{display:grid;gap:10px;margin:0;padding:0;list-style:none}.today-item{display:grid;grid-template-columns:74px minmax(0,1fr) auto;align-items:center;gap:18px;padding:16px 18px;background:var(--paper);border:1px solid var(--line);border-left:4px solid var(--line)}.today-item--pendente{border-left-color:var(--mustard)}.today-item--confirmado{border-left-color:var(--olive)}.today-item--cancelado{border-left-color:var(--terracotta)}.today-item time{font:500 21px 'Newsreader',Georgia,serif}.today-item strong,.today-item span{display:block}.today-item strong{margin-bottom:4px}.today-item span{color:var(--muted-ink);font-size:12px}@media(max-width:980px){.metric-grid{grid-template-columns:repeat(2,1fr)}.metric-card:nth-child(2){border-right:0}.metric-card:nth-child(-n+2){border-bottom:1px solid var(--line)}}@media(max-width:600px){.metric-grid{grid-template-columns:1fr}.metric-card{min-height:130px;border-right:0;border-bottom:1px solid var(--line)}.metric-card:nth-child(2){border-bottom:1px solid var(--line)}.today-panel{padding:18px}.section-heading{align-items:flex-start;flex-direction:column}.today-item{grid-template-columns:62px 1fr}.today-item .status-badge{grid-column:2}}
`
