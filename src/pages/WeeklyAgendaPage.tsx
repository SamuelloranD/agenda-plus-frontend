...
const appointmentActionStyles = `.appointment-status-row{display:flex;align-items:center;gap:6px;flex-wrap:wrap}.appointment-actions{grid-column:auto;margin:0}`
