...
export function WeeklyAgendaPage() {
  ...
  const appointmentsQuery = useAgendamentos({ dataInicio: dateKey(weekStart), dataFim: dateKey(weekEnd), tamanho: 200 })
