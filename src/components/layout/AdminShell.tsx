...
.admin-new-appointment{display:block;margin:0 0 22px;padding:12px 14px;color:#fff!important;background:var(--terracotta);border:1px solid var(--terracotta)!important;border-radius:4px;text-align:center!important;font-weight:700!important}.admin-new-appointment:hover{background:#a6472e!important}
