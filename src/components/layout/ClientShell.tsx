...
.client-new-appointment{display:block;margin:0 0 22px;padding:12px 14px;color:#fff!important;background:var(--terracotta);border:1px solid var(--terracotta);border-radius:4px;text-align:center;text-decoration:none;font-size:13px;line-height:1.4;font-weight:700}.client-new-appointment:hover{background:#a6472e!important}
.client-sidebar nav{display:grid;gap:7px}.client-sidebar nav a{display:flex;align-items:center;gap:10px;padding:12px 14px;color:var(--muted-ink);text-decoration:none;border:1px solid transparent;border-radius:4px;font-size:13px}.client-sidebar nav a:hover{background:color-mix(in srgb,var(--paper) 75%,var(--line));border-color:var(--line)}.client-sidebar nav a.client-nav-link--active{color:var(--olive);background:color-mix(in srgb,var(--paper) 82%,var(--mustard));border-color:var(--line);box-shadow:inset 3px 0 var(--terracotta);font-weight:700}
.client-logout{display:flex;align-items:center;gap:10px;width:100%;margin-top:28px;padding:11px 14px;color:var(--muted-ink);background:transparent;border:1px solid var(--line);border-radius:4px;cursor:pointer;font-size:12px;font-weight:700;letter-spacing:.08em;text-align:left;text-transform:uppercase}.client-logout:hover{color:var(--terracotta);border-color:var(--terracotta);background:color-mix(in srgb,var(--paper) 82%,var(--terracotta))}
