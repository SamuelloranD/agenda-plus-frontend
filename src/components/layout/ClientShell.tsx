...
.client-shell{min-height:100svh;display:grid;grid-template-columns:250px 1fr;color:var(--ink);background:var(--paper)}
.client-sidebar{padding:28px 20px;background:var(--paper);border-right:1px solid var(--line)}
...
@media(max-width:760px){.client-shell{display:block}.client-sidebar{position:fixed;inset:0 auto 0 0;width:250px;z-index:3;transform:translateX(-100%);transition:transform .2s}.client-main{padding:24px 20px}.client-shell .admin-menu-button{display:flex}.client-shell .admin-header h1{font-size:42px}.client-sidebar-overlay{position:fixed;inset:0;z-index:2;display:block;border:0;background:rgb(31 31 30 / 72%)}.client-shell.sidebar-open .client-sidebar{transform:translateX(0)}}
`
